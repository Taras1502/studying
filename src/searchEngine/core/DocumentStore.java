...
import searchEngine.newStructure.Document;
...
public class DocumentStore {
    ...
    private Map<Integer, searchEngine.core.Document> documents;
    private Map<Integer, List<Integer>> hashes;
    private boolean committed;
    private boolean updated;

    private DocumentStore(String path, Map<Integer, searchEngine.core.Document> documents, Map<Integer, List<Integer>> hashes) {
        this.path = path;
    ...
    public static DocumentStore load(String path) {
        Map<Integer, searchEngine.core.Document> documents = new HashMap<>();
        ...
        try {
            ...
            do {
                ...
                searchEngine.core.Document currentDoc = new searchEngine.core.Document(segId, pos);
    ...
    public int registerDocument(String filePath, int segmentId) {
        ...
        try {
            ...
            searchEngine.core.Document doc = new searchEngine.core.Document(segmentId, docsFile.length());
    ...
    public void updateSegmentForDoc(int docId, int segmentId) {
        searchEngine.core.Document doc = documents.get(docId);
    ...
    private String getFilePath(RandomAccessFile store, int id) {
        searchEngine.core.Document doc = documents.get(id);
        if (doc != null) {
    ...
    public boolean commit() {
        ...
        RandomAccessFile docsFile = getDocsFile();
        try {
            for (Map.Entry<Integer, searchEngine.core.Document> rec: documents.entrySet()) {
                searchEngine.core.Document doc = rec.getValue();
                if (doc.isUpdated()) {
