...
import searchEngine.interfaces.PostList;
...
public class DiscSegment {
    ...
    public searchEngine.newStructure.PostList getPostList(int pos) {
        try {
            ...
            index.read(postList);
            return searchEngine.newStructure.PostList.fromBytes(postList);
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            try {
